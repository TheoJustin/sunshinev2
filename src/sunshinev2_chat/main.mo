...
persistent actor {
    ...
    transient var dummyGenerated = false;
    type Friend = {
        id : Text;
        user1 : Principal;
        user2 : Principal;
    ...
    transient let chats = TrieMap.TrieMap<Text, Chat>(Text.equal, Text.hash);
    transient let friends = TrieMap.TrieMap<Text, Friend>(Text.equal, Text.hash);
